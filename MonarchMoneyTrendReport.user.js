...
function Sankey_Trends(InExec) {
    ...
    switch (InExec) {
        ...
        case 2:
            ...
            if(TrendButtonN != null) {
                TrendButtonN.style.display = "block";
            }
            TrendActive = true;
            break;
    }
    ...
    function Trend_BreakdownReport() {
        ...
        row = Trend_Table1(Hrow,'','Compared to: ' + Trend_ConvertDate(TrendStartP) + ' - ' + Trend_ConvertDate(TrendEndP),'Comparison','This Period','Difference');
...
function Sankey_UnhideTrends() {
    ...
    if(document.querySelector('button.TrendButton') == null) {
        ...
        TrendButtonN.textContent = 'Copy to Clipboard';
        TrendButtonN.className = 'TrendButtonN ' + TrendButtonC;
        ReportControlsEl.before(TrendButtonN);
