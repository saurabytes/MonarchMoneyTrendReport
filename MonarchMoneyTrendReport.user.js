...
function Sankey_Trends(InExec) {
    ...
    function Trend_BreakdownReport() {
        ...
        let row = null;
        let useStyle = "";
        const HeaderStr = 'Compared to: ' + Trend_ConvertDate(TrendStartP) + ' - ' + Trend_ConvertDate(TrendEndP);
